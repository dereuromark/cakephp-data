...
<?php } ?>
		...
		<td>
			...
			<?php echo $this->Html->link($this->Format->yesNo($smiley['Smiley']['is_base']), ['action' => 'toggle', 'is_base', $smiley['Smiley']['id']], ['escape' => false]); ?>
			</span>
		</td>
		<td>
			<span class="ajaxToggling" id="ajaxToggle-active-<?php echo $smiley['Smiley']['id']?>">
			<?php echo $this->Html->link($this->Format->yesNo($smiley['Smiley']['active']), ['action' => 'toggle', 'active', $smiley['Smiley']['id']], ['escape' => false]); ?>
			</span>
		</td>
		<td>
