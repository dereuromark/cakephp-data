...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink($this->Format->icon('delete'), ['action' => 'delete', $mimeTypeImage['MimeTypeImage']['id']], ['escape' => false], __('Are you sure you want to delete # %s?', $mimeTypeImage['MimeTypeImage']['id'])); ?>
			<?php
