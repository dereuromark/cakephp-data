...
<div class="actions">
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Mime Type Image'), ['action' => 'delete', $mimeTypeImage['MimeTypeImage']['id']], ['escape' => false], __('Are you sure you want to delete # %s?', $mimeTypeImage['MimeTypeImage']['id'])); ?> </li>
