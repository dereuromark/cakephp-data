...
<div class="actions">
	<ul>
		<li><?php echo $this->Html->link(__('Edit {0}', __('Language')), ['action' => 'edit', $language['Language']['id']]); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete {0}', __('Language')), ['action' => 'delete', $language['Language']['id']], null, __('Are you sure you want to delete # {0}?', $language['Language']['id'])); ?> </li>
