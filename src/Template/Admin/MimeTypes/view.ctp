...
<div class="actions">
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Mime Type'), ['action' => 'delete', $mimeType['MimeType']['id']], ['escape' => false], __('Are you sure you want to delete # {0}?', $mimeType['MimeType']['id'])); ?> </li>
